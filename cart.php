...
<head>
    ...
    <!-- BASE CSS -->
    <link href="test/css/bootstrap.custom.min.css" rel="stylesheet">
    <link href="test/css/style.css" rel="stylesheet">

	<!-- SPECIFIC CSS -->
    <link href="test/css/cart.css" rel="stylesheet">

    <!-- YOUR CUSTOM CSS -->
    <link href="test/css/custom.css" rel="stylesheet">
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="img/products/product_placeholder_square_small.jpg" data-src="<?php echo $item["image"]; ?>" class="lazy" alt="Image">
										</div>
									...
									<td class="options">
										<a href="cart.php?action=remove&code=<?php echo $item["code"]; ?>"><i class="ti-trash"></i></a>
									</td>
								</tr>
								<?php
