...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM hot_items WHERE code='" . $_GET["code"] . "'");
			$itemArray = array($productByCode[0]["code"]=>array('name'=>$productByCode[0]["name"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["new_price"], 'image'=>$productByCode[0]["image"]));
						...
						<ul class="top_tools">
							<li>
								<div class="dropdown dropdown-cart">
									<a href="cart.php" class="cart_bt"><strong>*</strong></a>
		...
		?>
											...
											<li>
												...
												<a href="product-detail-1.html">
													<figure><img src="img/products/product_placeholder_square_small.jpg" data-src="https://punalur.ml/<?php echo $item["image"]; ?>" alt="" width="50" height="50" class="lazy"></figure>
													<strong><?php echo $item["quantity"]; ?> X <span><?php echo $item["name"]; ?></span><?php echo  number_format($item_price,2); ?></strong>
												</a>
												<a href="hot_item_detail.php?action=remove&code=<?php echo $item["code"]; ?>&view=<?php echo $v ?>" class="action"><i class="ti-trash"></i></a>
											</li>
...
?>
	...
	$product_array = $db_handle->runQuery("SELECT * FROM hot_items where id=$v");
...
<div class="countdown_inner">-<?php echo $discount ?>% This offer ends in <div data-countdown='<?php echo $product_array[$key]["count_date"]; ?>' class="countdown"></div></div>
	        ...
	        <div class="row">
	            <div class="col-md-6">
	                <div class="all">
	                    <div class="slider">
                            <form method="post" action="hot_item_detail.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>&view=<?php echo $v ?>">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url('https://punalur.ml/<?php echo $product_array[$key]["image"]; ?>');" class="item-box"></div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="prod_info">
	                    ...
	                    <span class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i><em>18 reviews</em></span>
	                    ...
	                    <div class="row">
	                        <div class="col-lg-5 col-md-6">
	                            <div class="price_main"><span class="new_price"><?php echo "Price : ".$product_array[$key]["new_price"]; ?></span>
                                <span class="old_price"><?php echo $product_array[$key]["old_price"]; ?></span>
                                 </div>
	                        </div>
	                        <div class="col-lg-4 col-md-6">
	                            <div class="btn_add_to_cart"><input type="submit" value="Add to Cart" class="btn_1"></div>
	                        </div>
	                    </div>
	                </div>
                     <?php
