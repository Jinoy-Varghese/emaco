...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM featured_items WHERE code='" . $_GET["code"] . "'");
    ...
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
											...
											<li>
												...
												<a href='product-featured-detail.php?action=remove&code=<?php echo $item["code"]; ?>&view=<?php echo $_GET["view"]; ?>' class="action"><i class="ti-trash"></i></a>
											</li>
...
?>
	...
	$product_array = $db_handle->runQuery("SELECT * FROM featured_items where id=$v");
	...
	?>
	        ...
	        <div class="row">
	            <div class="col-md-6">
	                <div class="all">
	                    <div class="slider">
                            <form method="post" action="product-featured-detail.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>&view=<?php echo $v ?>">
	                ...
	                <div class="prod_info">
	                    ...
	                    <div class="row">
	                        <div class="col-lg-5 col-md-6">
	                            <div class="price_main"><span class="new_price"><?php echo "Price : ".$product_array[$key]["price"]; ?></span> </div>
	                        </div>
