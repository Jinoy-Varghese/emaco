...
switch($_GET["action"]) {
	...
	case "remove":
		$code=$_GET["code"];
        $sql = "delete from featured_items where code='$code'";
...
?>
    ...
    if (isset($_POST['upload']))
    {
        ...
        $sql = "INSERT INTO featured_items(name,code,image,price,type) VALUES ('$iname','$code','$image',$price,'$type')";
        mysqli_query($conn, $sql);
...
<?php
 $result = mysqli_query($conn, "SELECT * FROM featured_items");
 ...
 while ($row = mysqli_fetch_array($result))
     {
        ...
        <td><a href='featured_items.php?action=remove&code=".$row['code']."'>&nbsp;<img id=imgjp src='icon-delete.png' alt='Remove Item' />&nbsp;</a></td>
